...
class _ProductApiService implements ProductApiService {
  _ProductApiService(
    ...
    baseUrl ??= 'http://192.168.150.169:9090/api/product';
  }
  ...
  Future<HttpResponse<List<ProductModel>>> getProducts() async {
    ...
    var value = _result.data!
        .map((dynamic i) => ProductModel.fromMap(i as Map<String, dynamic>))
        .toList();
  ...
  @override
  Future<HttpResponse<void>> saveProduct(ProductModel request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
